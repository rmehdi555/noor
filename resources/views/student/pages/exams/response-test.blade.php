            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="bu-inner-main-form">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('student.exams.response.test.save') }}">

                            @csrf
                            <input type="hidden" name="exams_id" value="{{$exam->id}}">
                            <input type="hidden" name="class_rooms_students" value="{{$classRoomsStudents->id}}">
                            @php $i=1;@endphp
