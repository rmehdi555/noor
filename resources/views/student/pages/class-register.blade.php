            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-info m-1">
                        <a href="{{\App\Providers\MyProvider::_text($siteDetailsProvider["box_students_level_link"]->value)}}" target="_blank">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-primary m-1">
                        {!! \App\Providers\MyProvider::_text($siteDetailsProvider["page_students_class_register_body"]->value) !!}
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="bu-inner-main-form">
                        ...
                        <form class="form-horizontal" id="form-level-1-save" method="POST"
                              action="{{ route('student.class.register.save') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('students.class.register.field.add') }}">
                            @csrf
                                    ...
                                    @foreach($studentFields as $item)
                                        <tr>
                                            ...
                                            <td><a class="btn btn-danger btn-sm"
                                                   href="{{ route('students.class.register.field.delete',$item->id) }}">{{__('web/public.delete')}}</a>
                                            </td>
                                        </tr>
