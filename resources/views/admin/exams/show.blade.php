                ...
                <div class="col-md-12">
                    <div class="bu-inner-main-form">
                        ...
                        @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="alert alert-primary m-1">
                                                ...
                                                <br>
                                                تنها سوالات فعال درنظر گرفته میشوند و سوالات غیر فعال معادل حذف شده هستند .
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <a class="btn btn-info" href="{{ route('admin.exams.questions.create',$exam->id) }}">اضافه کردن سوال جدید</a>
                                ...
                                <table class="table table-bordered table-hover js-basic-example dataTable">
                                    ...
                                    @foreach($examQuestions as $item)
                                        <tr>
                                            ...
                                            <td><a class="btn btn-info" href="{{ route('admin.exams.questions.edit',$item->id) }}">ویرایش سوال</a></td>
                                        </tr>
                                        @php $i++ @endphp
                                    @endforeach
                                    </tbody>
