                    ...
                    <div class="bu-inner-main-form">
                        ...
                        <div class="row">
                            <div class="col-md-3 padding-top-15">
                                <label class="col-md-12 col-sm-6 control-label">نام معلم :  </label>
                                <label class="col-md-12 col-sm-6 control-label">{{$classRooms->user->name}}</label>

                            </div>
                            <div class="col-md-3 padding-top-15">
                                <label class="col-md-12 col-sm-6 control-label">نام خانوادگی معلم :  </label>
                                <label class="col-md-12 col-sm-6 control-label">{{$classRooms->user->family}}</label>

                            </div>
                            <div class="col-md-3 padding-top-15">
                                <label class="col-md-12 col-sm-6 control-label">کد معلم القرآنی :  </label>
                                <label class="col-md-12 col-sm-6 control-label">{{$classRooms->user->user_name}}</label>

                            </div>
                            <div class="col-md-3 padding-top-15">
                                <label class="col-md-12 col-sm-6 control-label">نام پدر معلم :  </label>
                                <label class="col-md-12 col-sm-6 control-label">{{$classRooms->user->teacher->f_name}}</label>
                        ...
                        {{--<form class="form-horizontal" method="POST" action="{{ route('admin.act.list.save') }}">--}}
                            ...
                            {{--<div class="row">--}}
                                {{--<div class="col-md-4 padding-top-15">--}}
                                    ...
                                    {{--</label>--}}
                                    {{--<div class="col-md-12 col-sm-6">--}}
                                        {{--<input type="number" step="0.001" name="s_h_t" id="s_h_t"  class="form-control" />--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                                {{--<div class="col-md-4 padding-top-15">--}}
