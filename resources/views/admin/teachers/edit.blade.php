                        ...
                        <div class="body">
                            ...
                            <form class="form-horizontal" id="form-level-1-save" method="POST"
                                        ...
                                        <div class="col-md-12 col-sm-10">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio"
                                                       name="sex"
                                                       value="female"
                                                       @if($teacher->sex=="female") checked @endif>{{__('admin/public.female')}}
                                            </label>
                                            @error('sex')
                                    ...
                                    <div class="col-md-6 padding-top-15">
                                        <label class="col-md-6 col-sm-6 control-label"
                                               for="sh_number">{{__('admin/public.sh_number')}} : <span
                                                    class="required">*</span></label>
                                        <div class="col-md-12 col-sm-10">
                                            <input type="text" name="sh_number" id="sh_number"
                                                   value="{{$teacher->sh_number}}"
                                                   id="input-name"
                                                   class="form-control  @error('sh_number') is-invalid @enderror"
                                                   required/>
                                            @error('sh_number')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-6 padding-top-15">
                                        <label class="col-md-6 col-sm-6 control-label"
                                               for="sh_sodor">{{__('admin/public.sh_sodor')}} : <span
                                                    class="required">*</span></label>
                                        <div class="col-md-12 col-sm-10">
                                            <input type="text" name="sh_sodor" id="sh_sodor"
                                                   value="{{$teacher->sh_sodor}}"
                                                   id="input-name"
                                                   class="form-control  @error('sh_sodor') is-invalid @enderror"
                                                   required/>
                                            @error('sh_sodor')
                                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 padding-top-15">
                                        <label class="col-md-6 col-sm-6 control-label"
                                               for="married">{{__('admin/public.married')}} : <span
                                                    class="required">*</span></label>
                                        <div class="col-md-12 col-sm-10">
                                            <label class="radio-inline" style="padding: 10px 40px 10px">
                                ...
                                <div class="row div-married div-married-yes">
                                    ...
                                    <div class="col-md-6 padding-top-15">
                                        <label class="col-md-6 col-sm-6 control-label"
                                               for="number_of_children">{{__('admin/public.number_of_children')}} :
                                            <span
                                                    class="required">*</span></label>
                                        <div class="col-md-12 col-sm-10">
                                ...
                                <div class="row div-married div-married-no">
                                    ...
                                    <div class="col-md-6 padding-top-15">
                                        <label class="col-md-6 col-sm-6 control-label"
                                               for="phone_f">{{__('admin/public.phone_f')}} : <span
                                                    class="required">*</span></label>
                                        <div class="col-md-12 col-sm-10">
                                    ...
                                    <div class="col-md-6 padding-top-15">
                                        <label class="col-md-6 col-sm-6 control-label"
                                               for="phone_m">{{__('admin/public.phone_m')}} : <span
                                                    class="required">*</span></label>
                                        <div class="col-md-12 col-sm-10">
                                            <input type="tel" placeholder="{{__('admin/public.example')}} : 09125555555"
                                ...
                                <div class="row">
                                    <div class="col-md-6 padding-top-15">
                                        <label class="col-md-6 col-sm-6 control-label"
                                               for="phone_1">{{__('admin/public.phone_1')}} : <span
                                                    class="required">*</span></label>
                                        <div class="col-md-12 col-sm-10">
                                            <input type="tel" placeholder="{{__('admin/public.example')}} : 09125555555"
                                ...
                                <div class="row">
                                    <div class="col-md-6 padding-top-15">
                                        <label class="col-md-6 col-sm-6 control-label"
                                               for="address">{{__('admin/public.address')}} : <span
                                                    class="required">*</span></label>
                                        <div class="col-md-12 col-sm-10">
                                    ...
                                    <div class="col-md-6 padding-top-15">
                                        <label class="col-md-6 col-sm-6 control-label"
                                               for="post_number">{{__('admin/public.post_number')}} : <span
                                                    class="required">*</span></label>
                                        <div class="col-md-12 col-sm-10">
                                            <input type="number" name="post_number" id="post_number" minlength="10"
                                                   maxlength="10"
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    @foreach($teacher->documents as $item)
                                        <tr>
                                            <td>{{$i}}</td>
                                            <td><a href="{{asset($item->url)}}" target="_blank">{{$item->title}}</a>
                                            </td>
                                        </tr>
                                        @php $i++; @endphp
                                    @endforeach
                            ...
                            <p class="bu-margin-bottom-30">در صورت اضافه کردن یا ویرایش مدارک عنوان مدرک و فایل آن را
                                وارد نمایید </p>
                            <form class="form-horizontal" id="form-level-1-save" method="POST"
                                  action="{{ route('teachers.add.file',$teacher->id) }}" enctype="multipart/form-data">
                                @csrf
                            <div class="row">
                                <div class="col-md-6 padding-top-15">
                                ...
                                <div class="col-md-6 padding-top-15">
                                    <label class="col-md-9 col-sm-9 control-label" for="p_image">فایل مدرک را انتخاب
                                        نمایید: </label>
                                    <div class="col-md-12 col-sm-10">
                                ...
                                <div class="d-flex justify-content-center mb-2">
                                    <div class="p-2 ">
                                        <button type="submit"
                                                class="btn btn-primary">{{__('admin/public.upload')}}</button>
                                    </div>
                                </div>
