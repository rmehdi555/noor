    ...
    <section class="">
        <div class="container">
            <div class="row">
                ...
                <div class="card col-md-5" style="background-color: #fefe33 ;  margin : 5px ;  width: 100%">
                    <a href="{{ route('login') }}" style="text-align:center; padding-top: 10px; padding-bottom:10px;">
                        <h3 class="main-iconbox-ic-title text-dark" >سامانه قرآن آموزان </h3>
                    </a>
                </div>
                <div class="card text-white  col-md-5" style="background-color: #008B8B ;  margin : 5px ; width: 100%">
                    <a href="{{ route('login') }}" style="text-align:center; padding-top: 10px;  padding-bottom:10px;">
                        <h3 class="main-iconbox-ic-title text-white">سامانه معلم القرآن ها </h3>
                    </a>
                </div>
                <div class="col-md-1">
