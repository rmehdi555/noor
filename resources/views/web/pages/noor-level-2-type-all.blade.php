                ...
                <div class="col-md-12">
                    <div class="alert alert-info m-1">
                        ...
                        <p class="p-1 text-justify">جناب
                            ...
                            <br>
                            تاریخ :
                        {{\App\Providers\MyProvider::show_date($noor->created_at,'Y-n-j H:i')}}
                ...
                <div class="col-md-12">
                    <div class="alert alert-info m-1">
                        ...
                        <p class="p-1 text-justify">
                            خیّر گرامی خدای سبحان خود شاکر است و سعی شما را مشکور قرار خواهد داد و پاداشی در خور عنایت خواهد کرد «إن شاء الله» امیدواریم حضرت موعود ارواحنا فداه وجود خویش را سایه سار زندگیتان سازد، تا در خنکای آن،، کمال، آرامش و برکت، لذت بخش زندگیتان شده و عروج به مقام اعلای قرب الهی را نصیبتان نماید.
                            </p>
