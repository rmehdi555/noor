            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-primary m-1">
                        ...
                        <br>
                        شماره شبا اختیاری میباشد و در وارد کردن شماره کارت دقت لازم را داشته باشین زیرا قابل ویرایش نمیباشد .
                    </div>
                </div>
            </div>
                    ...
                    <div class="bu-inner-main-form">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('teacher.card.number.bank.create.save') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 padding-top-15">
                                    <label class="col-md-12 col-sm-6 control-label" for="description">شماره کارت : ( بدون فاصله یا خط تیره بنویسید) <span class="required">*</span>
                                    </label>
                                    <div class="col-md-12 col-sm-6">
                                        <input type="text" name="card_number" id="card_number" placeholder="6037997267595555" class="form-control" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
