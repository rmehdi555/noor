                ...
                <div class="col-md-12">
                    <div class="bu-inner-main-form">
                        ...
                        <div class="row">
                            ...
                            <h5>برای پاسخ به فعالیت اطلاعات زیر را وارد نمایید</h5>


                            <form class="form-horizontal" method="POST" action="{{ route('teacher.practice.save.ans') }}" enctype="multipart/form-data">
                                @csrf
